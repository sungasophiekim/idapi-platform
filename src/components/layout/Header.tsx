...
export default function Header() {
  ...
  return (
    <header className={`fixed top-10 left-0 right-0 z-50 bg-white/[0.94] backdrop-blur-xl border-b border-border transition-shadow duration-300 ${scrolled ? 'shadow-sm' : ''}`}>
