...
export default function AboutPage() {
  ...
  const sections = [
    { title: 'Independent. Policy-driven. Globally Connected.',
      ko: 'iDAPI는 민간 주도의 독립적 거버넌스를 기반으로 설립된 정책 연구소로, 디지털·AI 공공 인프라 분야에 참여해 온 전문가들과 정책·법률 분야 전문 인력이 중심이 되어 2025년 연구를 시작했습니다. 우리는 연구 결과의 발간에 머무르지 않고 정책 결정자, 공공기관, 산업 참여자 간 실질적인 대화를 촉진함으로써 정책 변화와 사회의 지속 가능한 발전을 지원합니다.',
      en: 'iDAPI is an independent policy research institute founded on privately led governance. Launched in 2025 by experts in digital & AI public infrastructure together with policy and legal professionals, the institute goes beyond publishing research to convene meaningful dialogue among policymakers and industry stakeholders.' },
    { title: 'Global Strategic Base',
      ko: 'iDAPI는 아시아 디지털·AI 공공 인프라 정책 논의의 핵심 허브인 싱가포르에 비영리 재단으로 설립되었습니다. 이를 기반으로 한국의 정책 경험과 연구 성과를 국제사회와 연결하고, 글로벌 기준과 국내 제도 간 정합성을 높이는 전략적 가교 역할을 수행합니다.',
      en: 'iDAPI is a non-profit foundation established in Singapore, a key hub for digital & AI public infrastructure policy in Asia. From this strategic base, it bridges Korea\'s policy expertise with the global community.' },
  ...
  return (
    <section className="pt-32 pb-20 max-w-[800px] mx-auto px-6">
      ...
      <p className="text-[15px] text-gray-500 leading-relaxed mb-8">
        {t(
          '디지털·AI 공공인프라 연구소(iDAPI)는 정책, 법률, 기술, 공공 인프라 분야 전문가들이 참여하는 비영리·비당파 정책 연구기관으로, 디지털·AI 시대의 공공 인프라를 설계합니다. 다학제적 전문성을 바탕으로 공공의 이익과 기술 혁신이 균형을 이루는 합리적이고 실행 가능한 정책 프레임워크를 제시합니다.',
          'iDAPI is a non-profit, non-partisan policy think tank shaping public infrastructure for the digital & AI era, uniting experts across policy, law, technology, and public infrastructure to develop balanced, actionable frameworks.'
        )}
      </p>
      {sections.map(s => (
